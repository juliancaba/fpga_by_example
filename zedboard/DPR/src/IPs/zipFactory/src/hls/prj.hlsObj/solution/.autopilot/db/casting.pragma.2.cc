# 1 "/home/julian/workspace/devel/fpga_by_example/zedboard/DPR/src/IPs/zipFactory/src/hls/prj.hlsObj/solution/.autopilot/db/casting.pragma.1.cc"
# 1 "/home/julian/workspace/devel/fpga_by_example/zedboard/DPR/src/IPs/zipFactory/src/hls/prj.hlsObj/solution/.autopilot/db/casting.pragma.1.cc" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 155 "<built-in>" 3
# 1 "<command line>" 1
...
# 8 "<command line>" 2
# 1 "<built-in>" 2
# 1 "/home/julian/workspace/devel/fpga_by_example/zedboard/DPR/src/IPs/zipFactory/src/hls/prj.hlsObj/solution/.autopilot/db/casting.pragma.1.cc" 2
# 1 "./casting.cc"
# 1 "./casting.cc" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
...
void
to_char_short(short n, unsigned char bytes[2])
{_ssdm_SpecArrayDimSize(bytes,2);
  bytes[0] = (n >> 8) & 0xFF;
  bytes[1] = n & 0xFF;
}
...
void
to_char_int(int n, unsigned char bytes[4])
{_ssdm_SpecArrayDimSize(bytes,4);
  bytes[0] = (n >> 24) & 0xFF;
  bytes[1] = (n >> 16) & 0xFF;
  bytes[2] = (n >> 8) & 0xFF;
  bytes[3] = n & 0xFF;
...
void
to_char_long_long(long long n, unsigned char bytes[8])
{_ssdm_SpecArrayDimSize(bytes,8);
  bytes[0] = (n >> 56) & 0xFF;
  bytes[1] = (n >> 48) & 0xFF;
  bytes[2] = (n >> 40) & 0xFF;
  bytes[3] = (n >> 32) & 0xFF;
