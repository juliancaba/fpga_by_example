...
set ip_name axi_zipFactory_v1
set SRCfolder src
if {[lindex $argv 0] == "2017_4"} {
    set SRCfiles [list axi_zipFactory.vhd factory_axi2fifo_bridge.vhd factory_axis2pr_bridge.vhd getRequestHead_wobkb.vhd wrapperAdmin.vhd Block_proc11.vhd factory_pr32.vhd forward.vhd factory_adminPR.vhd fifo_w32_d16_A.vhd getRequestHead.vhd unzip.vhd fifo_zipFactory.vhd]
} elseif {[lindex $argv 0] == "2016_4"} {
    set SRCfiles [list Block_proc.vhd factory_adminPR.vhd getRequestHead.vhd Block_proc_buffercud.vhd factory_axi2fifo_bridge.vhd factory_pr32.vhd getRequestHead_wobkb.vhd factory_axis2pr_bridge.vhd unzip.vhd axi_zipFactory.vhd forward.vhd wrapperAdmin.vhd fifo_zipFactory.vhd]
} elseif {[lindex $argv 0] == "2015_4"} {
    set SRCfiles [list FIFO_wrapperAdmin_Block_proc_bufferRESP_V.vhd wrapperAdmin_Block_proc.vhd wrapperAdmin_forward.vhd axi_zipFactory.vhd factory_pr32.vhd wrapperAdmin_getRequestHead.vhd factory_adminPR.vhd wrapperAdmin_getRequestHead_words32.vhd factory_axi2fifo_bridge.vhd unzip.vhd factory_axis2pr_bridge.vhd wrapperAdmin.vhd fifo_zipFactory.vhd]
} else {
    error "Version not found"
}
set SIMfolder src
set SIMfiles [list ICAPE2.vhd zipFactory_tb.vhd]
