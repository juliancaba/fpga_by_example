...
set ip_name factory_client_v1
set SRCfolder src
set SRCfiles [list factory_client.vhd]
set SIMfolder src
set SIMfiles [list factory_client_tb.vhd]
...
# Create project
create_project $prj_name $origin_dir/$prj_name -part $part
...
# create_ip -name fifo_generator -vendor xilinx.com -library ip -version 12.0 -module_name FIFO_IO
# set_property -dict [list CONFIG.Fifo_Implementation {Independent_Clocks_Block_RAM} CONFIG.Input_Data_Width {32} CONFIG.Valid_Flag {true} CONFIG.Output_Data_Width {32} CONFIG.Full_Threshold_Assert_Value {1021} CONFIG.Full_Threshold_Negate_Value {1020}] [get_ips FIFO_IO]
